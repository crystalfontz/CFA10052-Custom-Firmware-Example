...
#define LCDCore_Init			ST7529_Init
#define LCDCore_WriteContrast	ST7529_WriteContrast
#define LCDCore_BufferToLCD		ST7529_BufferToLCD
#define LCDCore_BusToWrite		ST7529_BusToWrite
#define LCDCore_BusToRead		ST7529_BusToRead
